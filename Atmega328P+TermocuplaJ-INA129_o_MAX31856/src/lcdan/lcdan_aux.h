...
#define lcdan_set_cursor_in_row0(x) do{lcdan_write_cmd(LCDAN_BASEADDR_ROW_0+x);__delay_us(50);}while(0)
#define lcdan_set_cursor_in_row1(x) do{lcdan_write_cmd(LCDAN_BASEADDR_ROW_1+x);__delay_us(50);}while(0)
#define lcdan_set_cursor_in_row2(x) do{lcdan_write_cmd(LCDAN_BASEADDR_ROW_2+x);__delay_us(50);}while(0)
#define lcdan_set_cursor_in_row3(x) do{lcdan_write_cmd(LCDAN_BASEADDR_ROW_3+x);__delay_us(50);}while(0)
